...
export default function FocusMode() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Session History */}
      {sessions.length > 0 && (
        <div className="rounded-2xl p-6 bg-slate-50 dark:bg-[#1a1a2e] border border-slate-200 dark:border-[#2a2a3e] max-w-md mx-auto">
          <h3 className="text-white font-semibold mb-3">Session History</h3>
          <div className="space-y-2">
            {sessions.map((s, i) => (
              <div key={i} className="flex items-center justify-between text-sm p-2 rounded-lg bg-slate-100 dark:bg-[#0f0f1a]">
