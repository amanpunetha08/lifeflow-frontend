    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => setCurrent(new Date())} className="text-sm text-gray-400 hover:text-white px-3 py-1.5 border border-[#2a2a3e] rounded-lg">Today</button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {/* Calendar Grid */}
        <div className="lg:col-span-3 rounded-2xl p-6 bg-[#1a1a2e] border border-[#2a2a3e]">
            ...
            {monthDays.map((day) => (
              <div key={day.toISOString()} onClick={() => setSelected(day)}
                className={`h-24 p-2 rounded-xl border cursor-pointer transition-colors ${
                  ...
                  isToday(day) ? 'border-indigo-500/50 bg-indigo-500/5' : 'border-[#2a2a3e] hover:border-[#3a3a4e]'
                }`}>
        ...
        <div className="rounded-2xl p-6 bg-[#1a1a2e] border border-[#2a2a3e]">
          ...
          <div className="space-y-3">
            ...
            {selectedEvents.map((e) => (
              <div key={e.id} className="p-3 rounded-xl bg-[#0f0f1a] border border-[#2a2a3e]">
