...
export default function Profile() {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      {/* Profile Header */}
      <div className="rounded-2xl p-8 bg-[#1a1a2e] border border-[#2a2a3e] text-center">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div key={s.label} className="rounded-2xl p-4 bg-[#1a1a2e] border border-[#2a2a3e] text-center">
      ...
      <div className="rounded-2xl p-6 bg-[#1a1a2e] border border-[#2a2a3e]">
        ...
        <div className="grid grid-cols-3 gap-4">
          {badges.map((b) => (
            <div key={b.name} className="text-center p-4 rounded-xl bg-[#0f0f1a] border border-[#2a2a3e]">
